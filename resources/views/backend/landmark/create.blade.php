        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">Add new landmark</div>
                    @if (session('status'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="details" type="details"
                                           class="form-control @error('details') is-invalid @enderror" id="inputEmail3"
...
{{--                            <input type="hidden" name="user_id" value="{{\Illuminate\Support\Facades\Auth::id()}}">--}}
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="country_id" id="country">
                                            ...
                                            @foreach($countries as $country)
                                                <option class="" value="{{$country->id}}">{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="exampleInputEmail1" class="col-sm-2 col-form-label">Country Name</label>
                                <div class="col-sm-10">
                                    <select class="form-control @error('city_id') is-invalid @enderror" name="city_id" id="cities">
