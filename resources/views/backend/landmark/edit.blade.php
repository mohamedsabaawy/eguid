        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">Update landmark</div>
                    @if (session('status'))
                    ...
                    <form action="{{route('landmark.update',$landmark->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="name" type="text"
                                           ...
                                           placeholder="Name" value="{{$landmark->name}}">
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="cover" type="file"
                                           class="form-control @error('cover') is-invalid @enderror" id="inputEmail3"
                                           placeholder="Email" value="{{old('cover')}}">
                                    @error('cover')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="details" type="details"
                                              class="form-control @error('details') is-invalid @enderror"
                                              id="inputEmail3"
                                              placeholder="details">{{$landmark->details}}</textarea>
                                    @error('details')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="country_id" id="country">
                                            ...
                                            @foreach($countries as $country)
                                                <option class=""
                                                        value="{{$country->id}}" {{($landmark->City->Country->id == $country->id ? 'selected' : '')}}>{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control @error('city_id') is-invalid @enderror" name="city_id"
                                            id="cities">
                                        <option value="{{$landmark->City->id}}">{{$landmark->City->name}}</option>
                                    </select>
                                    @error('city_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
