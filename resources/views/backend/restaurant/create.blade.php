        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {{--                        <div class="card-body">--}}
                    {{--                            <div class="form-group row">--}}
                    {{--                                <label for="exampleInputEmail1" class="col-sm-2 col-form-label">Restaurant Name</label>--}}
                    {{--                                <div class="col-sm-10">--}}
                    ...
                    {{--                            </div>--}}
                    {{--                            <div class="form-group row">--}}
                    {{--                                <label for="inputEmail3" class="col-sm-2 col-form-label">Restaurant Email</label>--}}
                    {{--                                <div class="col-sm-10">--}}
                    ...
                    {{--                            </div>--}}
                    {{--                            <div class="form-group row">--}}
                    {{--                                <label for="inputEmail3" class="col-sm-2 col-form-label">Restaurant Password</label>--}}
                    {{--                                <div class="col-sm-10">--}}
